...
/* Perform query */
$query = "SELECT productName, listPrice, img FROM products where categoryID='2'";
...
//            echo "<div class='slideshow-container'>";
  ...
  vertical-align: middle;' ></div>";
        echo "<div class='panel-footer'>Price: €" . $row->listPrice . "         <form action='addB.php' method='post'>
