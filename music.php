...
/* Perform query */
$query = "SELECT productName, listPrice, img FROM products where categoryID='4'";
...
//            echo "<div class='slideshow-container'>";
  ...
  vertical-align: middle;' ></div>";
        echo "<div class='panel-footer'>Price: €" . $row->listPrice . "         <form action='addCart.php' method='post'>
